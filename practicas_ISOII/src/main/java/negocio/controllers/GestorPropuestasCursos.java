...
public class GestorPropuestasCursos {
	...
	public CursoPropio realizarPropuestaCurso(String id, String nombre, int ECTS, Date fechaInicio, Date fechaFinal, double tasaMatricula, int edicion, EstadoCurso estado, TipoCurso tipo, String director, String secretario, int centro) {
		...
		CursoPropio curso = new CursoPropio(id, nombre, ECTS, fechaInicio, fechaFinal, tasaMatricula, edicion, estado, tipo, centro_, director_, secretario_);
